"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.PcrtInfinite=void 0;var _infiniteScroll=_interopRequireDefault(require("infinite-scroll"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,n){for(var r=0;r<n.length;r++){var t=n[r];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}function _createClass(e,n,r){return n&&_defineProperties(e.prototype,n),r&&_defineProperties(e,r),e}var infScroll=null,PcrtInfinite=function(){function l(e,n,r,t,i){_classCallCheck(this,l),this.reInit()}return _createClass(l,[{key:"reInit",value:function(){wrapper.style.display="none",loader.style.display="block",infScroll=new _infiniteScroll.default(el,{path:function(){var e=this.pageIndex-1;return urlnext+e},append:appender,history:!1}),loader.style.display="none",wrapper.style.display="block"}},{key:"next",value:function(){infScroll.nextPage()}}]),l}();exports.PcrtInfinite=PcrtInfinite;
"use strict";var $=require("jquery");function toggleSidebar(){$(".pcrt-sidebar").toggleClass("pcrt-close"),$(".pcrt-wrapper").toggleClass("pcrt-close")}
